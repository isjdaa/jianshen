                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="myForm" action="${pageContext.request.contextPath}/student?r=edit" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label> 入学日期</label>
                                        <input class="form-control js-datepicker m-b-10" type="text"  name="enterdate" placeholder="yyyy-mm-dd" value="${entity.enterdate}" data-date-format="yyyy-mm-dd" />
                                    </div>
                                    <div class="form-group">
                                        <label> 年龄</label>
                                        <input class="form-control" value="${entity.age}" type="number" name="age" >
                                    </div>
