...
<body>
<div class="row lyear-wrapper" style="background-image: url(${pageContext.request.contextPath}/main/web/assets/images/dlbj.png); background-size: cover;">
    <div class="lyear-login">
        <div class="login-center">
            <div class="login-header text-center">
                ...
                <h4 class="text-primary" style="margin-top:10px;">客户账号注册</h4>
            </div>
            <form>
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入客户编号（登录账号）" class="form-control" id="sno" />
                ...
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入教练编号" class="form-control" id="clazzno" />
                    <span class="mdi mdi-account-tie form-control-feedback" aria-hidden="true"></span>
                </div>
                <div class="form-group has-feedback feedback-left">
