                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <c:choose>
                                                <c:when test="not empty scheduleList">
                                                    <c:forEach items="${scheduleList}" var="schedule">
                                                        <tr>
                                                            ...
                                                            <c:if test="${sessionScope.role == 'admin'}">
                                                                <td>
                                                                    <a href="${pageContext.request.contextPath}/schedule?action=edit&id=${schedule.id}" class="btn btn-sm btn-warning">编辑</a>
                                                                    <button onclick="deleteSchedule('${schedule.id}', '${schedule.courseName}')" class="btn btn-sm btn-danger ml-1">删除</button>
                                                                </td>
                                                            </c:if>
                                                        </tr>
                                                    </c:forEach>
                                                ...
                                                <c:otherwise>
                                                    <tr>
                                                        <td colspan="${sessionScope.role == 'admin' ? 10 : 9}" class="text-center">暂无排课记录</td>
                                                    </tr>
                                                </c:otherwise>
                                            </c:choose>
                                            </tbody>
