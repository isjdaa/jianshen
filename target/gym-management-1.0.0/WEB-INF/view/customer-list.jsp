                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-inline" method="get" action="${pageContext.request.contextPath}/customer">
                                    <div class="form-group">
                                        <label class="sr-only" for="id">客户编号</label>
                                        <input type="text" class="form-control" id="id" name="id" placeholder="客户编号" value="${id}">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="name">客户姓名</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="客户姓名" value="${name}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="coachId" id="coachId">
                                            ...
                                            <c:forEach items="${coaches}" var="coach">
                                                <option value="${coach.id}" <c:if test="${coachId == coach.id}">selected</c:if>>${coach.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <button type="submit" class="btn btn-primary">搜索</button>
                                    <button type="button" class="btn btn-success" onclick="window.location.href='${pageContext.request.contextPath}/customer?r=add'">添加客户</button>
                                </form>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach items="${pagerVO.list}" var="customer">
                                            <tr>
                                                <td>${customer.id}</td>
                                                <td>${customer.name}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:del('${customer.id}')" class="btn btn-danger btn-xs">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
