    ...
    <div class="lyear-login">
        <div class="login-center">
            <div class="login-header text-center">
                ...
                <h4 class="text-primary" style="margin-top:10px;">教练注册</h4>
            </div>
            <form>
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入教练编号（登录账号）" class="form-control" id="id" />
                ...
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入专业特长" class="form-control" id="specialization" />
                    <span class="mdi mdi-star form-control-feedback" aria-hidden="true"></span>
                </div>
                <div class="form-group has-feedback feedback-left">
...
<script type="text/javascript">
    function register() {
        ...
        // 前端简单校验
        if(id==""||password==""||name==""||specialization==""){
            alert("教练编号、密码、姓名、专业特长为必填项！");
            return;
        }

        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/coach_register",
            dataType:"json",
            data:{id,password,name,tele,age,gender,specialization,address},
